...
title: "TPM vs Count Gene Ranking Analysis in Salmon in CD4+ T Cells from WT and Kdm6a cKO Mice"
author: "Mira Sohn" 
---
...
### - DE analysis: [Link](https://github.com/Mira0507/GSE157852/blob/master/DE_EnsDb.Rmd)
...
# Import data
rankdiff <- fread("tpmVScount_FDR_RankDiff.csv")[, -1]
...
(col.new <- c(col.original[1:11], 
             "Num.Transcripts",
             "Variant.Alleles",
             "Repetitive.Conserved",
             "Repetitive.Simple", 
             col.original[length(col.original)]))
